...
public class PlayerController : MonoBehaviour
{
    ...
    private Vector3 groundCheckPoint = new Vector3(0, -.87f, 0);
    ...
    */
    ...
    private void CollisionCheck()
    {
        ...
        if (sphereCol != null)
        {
            num = Physics.OverlapSphereNonAlloc(transform.TransformPoint(sphereCol.center), sphereCol.radius, overlaps, discludePlayer, QueryTriggerInteraction.Ignore);
